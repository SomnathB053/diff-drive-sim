...
def generate_launch_description():
    ...
    # Delay SLAM and EKF slightly to ensure /clock and sensor topics are alive
...
#     # Include sim.launch.py and forward the SLAM rviz config to it
#     sim_launch = IncludeLaunchDescription(
#         PythonLaunchDescriptionSource(sim_launch_path),
#         launch_arguments={
#             'rviz_config': rviz_config,
...
#         'params_file',
#         default_value=default_slam_params_path,
#         description='Full path to slam_toolbox configuration YAML',
#     )
...
#     # 2. Official slam_toolbox launch (handles lifecycle and param substitutions cleanly)
#     slam_toolbox_launch = IncludeLaunchDescription(
#         PythonLaunchDescriptionSource(
#             PathJoinSubstitution([pkg_slam_toolbox, 'launch', 'online_async_launch.py'])
#         ),
...
#     # 3. Delay SLAM start slightly so /clock and TF tree are actively publishing
